...
export async function GET() {
  ...
  const emailConnected = Boolean(commsSettings?.smtpUser || commsSettings?.encryptedResendApiKey);
  ...
  const items = [
    ...
    { key: "email", label: "Connect email so estimates and invoices actually send", done: emailConnected, linkUrl: "/settings/notifications" },
