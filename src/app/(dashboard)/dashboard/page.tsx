...
export default async function DashboardPage() {
  ...
  const [monthPayments, ytdPayments, openLeads, activeJobs, unpaidInvoices, recentLeads, followUpsDue] = await Promise.all([
    ...
    return (
      <div className="space-y-8">
        <div>
          ...
          <p className="text-sm text-graphite-400">Your pipeline and sales activity at a glance.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <StatCard label="Active jobs" value={String(activeJobs)} sublabel="from your closed deals" icon={Briefcase} tone="accent" />
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="card p-5">
            ...
            <div className="space-y-3">
              {followUpsDue.length === 0 ? <p className="text-sm text-graphite-400">Nothing due - you're caught up.</p> : null}
              {followUpsDue.map(function (lead) {
                return (
                  <Link key={lead.id} href={"/pipeline/" + lead.id} className="flex items-center justify-between text-sm group">
          ...
          <div className="card p-5">
            ...
            <div className="space-y-3">
              {recentLeads.length === 0 ? <p className="text-sm text-graphite-400">No leads yet. Add your first customer to get started.</p> : null}
