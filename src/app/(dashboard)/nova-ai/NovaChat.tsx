      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-4">
        {messages.length === 0 && (
          <div className="space-y-3">
            <p className="text-sm text-graphite-400">Ask Nova anything about {companyName} — try one of these:</p>
        ...
        {loading && <p className="text-xs text-graphite-500">Nova is thinking...</p>}
        <div ref={bottomRef} />
      </div>
      <form
        onSubmit={(e) => {
